<%-- 
    Document   : aaEnglish
    Created on : Apr 15, 2019, 12:00:53 AM
    Author     : Devna
--%>
...
<a href="homepage.jsp">Log Out</a><br>
    ...
    <div class="main">
        <a href="aaGrammar.jsp">
            <img src="grammar_img.jpg" height="250" width="800" border="2"></a>
        
        <a href="aaSpelling.jsp">
            <img src="spelling_img.jpg" height="250" width="800" border="2"></a>
