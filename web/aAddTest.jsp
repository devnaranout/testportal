<%-- 
    Document   : aAddTest
    Created on : Apr 14, 2019, 12:04:26 AM
    Author     : Devna
--%>
...
<a href="homepage.jsp">Log Out</a><br>
    ...
    <div class="main">
        <a href="aaEnglish.jsp">
            <img src="english_img.png" height="250" width="800" border="2"></a>
        
        <a href="aaMath.jsp">
            <img src="math_img.png" height="250" width="800" border="2"></a>
        
        <a href="aaReasoning.jsp">
            <img src="reasoning_img.jpg" height="250" width="800" border="2"></a>
